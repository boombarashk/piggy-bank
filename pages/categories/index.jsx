...
import { getCategoriesData, saveCategories } from "@/services/reducers/categories"
...
function Categories() {
    ...
    dispatch(saveCategories({data: [...categories, {id: uuidv4(), name: category} ]}));
  };
    ...
    return (<div className="tab-content">
        ...
        <Dialog id={ID_DIALOG_ADD_PROPERTY}
            okHandler={() => handleSave(newCategory/*todo clear Input  // new Date().toString()*/)}
            text={'Сохранить'}>
